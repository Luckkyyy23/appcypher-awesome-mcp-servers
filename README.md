...
- [Omni Service Node](https://github.com/Luckkyyy23/omni-service-node) - AI-to-AI data marketplace with 56 pay-per-call endpoints: market signals, macro economics, crypto/DeFi, earnings, insider trades, options flow, SEC/USPTO filings, geopolitical intelligence, whale tracking, ArXiv research, and more. Pays in USDC on Base Mainnet via x402 protocol.
